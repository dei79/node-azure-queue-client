...
function AzureQueueListener() {
    ...
    var _pollCounter = 0;
    var _queueConfig = {qName: null, qStorageAccountKey: null, qStorageAccountSecret: null, qPolling: 0, qStorageEndpointSuffix: null};
    ...
    function startCheckingQueuePeriodically() {
        ...
        pollPromise.finally(function() {
            ...
            var azureQueue = new AzureQueue(_queueConfig.qName, _queueConfig.qStorageAccountKey, _queueConfig.qStorageAccountSecret, _queueConfig.qStorageEndpointSuffix);
    ...
    self.listen = function (qName, qStorageAccountKey, qStorageAccountSecret, qPolling, qLogger, qStorageEndpointSuffix) {
        ...
        _queueConfig.qStorageEndpointSuffix = qStorageEndpointSuffix;
